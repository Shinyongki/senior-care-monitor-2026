      ...
      <div className="lg:col-span-2 order-1 lg:order-2 space-y-6">
        ...
        <Card title="📊 서비스 실태 점검" color="blue">
            ...
            <div>
                ...
                {['매우만족', '만족', '보통', '불만족'].map(opt => (
                    ...
                    className={`px-3 py-1.5 rounded text-sm border ${
                        formData.satisfaction === opt ? 'bg-blue-100 border-blue-500 text-blue-800 font-bold' : 'bg-white border-slate-300 text-slate-600'
                    }`}
                    >
                    {opt}
                    </button>
            ...
            <div>
                ...
                {['말벗서비스', '정보제공', '교육(치매예방)', '가사지원', '건강지원', '자원연계'].map(item => (
